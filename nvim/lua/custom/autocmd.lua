...
api.nvim_create_autocmd("FileType", {
    ...
    callback = function(ev)
        ...
        vim.keymap.set('n', '<Leader>x', ':call VimuxRunCommand("clear;python " . bufname("%"))<CR>',
        ...
        vim.keymap.set('i', '<F9>', 'from ipdb import set_trace; set_trace()<Esc>:w<CR>',
            opts('Insert ipdb breakpoint'))
    end,
})
